...
/**
 * struct passinfo - containing pseudo-arg passing into a function,
 * allows uniform prototype for function pointer struct
 * @arg: a str generated from getline containing arg
 ...
 * @fname: the program filename here
 * @env: linked list local copy of enviroment
